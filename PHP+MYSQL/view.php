            ...
            <tbody>
                ...
                <?php while (($fila = mysqli_fetch_assoc($resultado))) { ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <a class="col-2" href="logicalEdit.php?id=<?php echo $fila['user_id'] ?>"><input class="btn btn-primary" type="submit" value="Editar"></a>
                                <a class="col-2" href="logicalDelete.php?id=<?php echo $fila['user_id'] ?>"><input class="btn btn-danger" type="submit" value="Eliminar"></a>
                            </div>
                        </td>
                    </tr>
                <?php } ?>
