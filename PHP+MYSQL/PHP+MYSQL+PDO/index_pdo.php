...
<body>
    <div class="container">
    <br>
        <a class="d-grid gap-2 col-6 mx-auto" href="view_pdo.php"><input type="button" class="btn btn-primary" value="VER REGISTROS"></a>
        <br>
        <a class="d-grid gap-2 col-6 mx-auto" href="search_pdo.php"><input type="button" class="btn btn-primary" value="BUSCAR REGISTROS"></a>
        <br>
